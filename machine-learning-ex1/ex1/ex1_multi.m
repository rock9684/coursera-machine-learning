...
[theta2, J_history2] = gradientDescentMulti(X, y, theta, alpha2, 10000);
...
fprintf(' %f \n', theta);
fprintf('Theta0.03 computed from gradient descent: \n');
fprintf(' %f \n', theta1);
fprintf('Theta0.003 computed from gradient descent: \n');
fprintf(' %f \n', theta2);
fprintf('\n');
